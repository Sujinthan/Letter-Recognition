...
def changeFolderName ():
    ...
    '''
    main_src = '/mnt/c/Users/small/Downloads/by_class/'
    ...
    for filename in os.listdir(main_src):
        ...
        new_location = 'Images\ for\ CNN/train/'
        print("CHeck if directoyr exists")
        print(os.path.isdir( new_location))
        try:
...
def createTestFolder():
    ...
    for filename in os.listdir(main_src):
        ...
        new_location = 'Images\ for\ CNN/test/'
        new_filename = ord(bytes.fromhex(filename).decode("utf-8"))
        cmd = 'mkdir ' + new_location+str(new_filename)
        os.system(cmd)
    print("done creating folder in test")
    new_src = 'Images\ for\ CNN/test/'
    for filename in os.listdir(main_src):
        src = main_src + filename + '/hsf_*/*'
        new_filename =  str(ord(bytes.fromhex(filename).decode('utf-8')))
...
def countImages ():
    small = float("inf")
    main_src = '/mnt/c/Users/small/Desktop/Images for CNN/train/'
    for filename in os.listdir(main_src):
        count = 0
        src = main_src+filename 
        for img in os.listdir(src):
...
def invertMoverImage ():
    main_src = '/mnt/c/Users/small/Desktop/Images for CNN/train/'
    test_src = '/mnt/c/Users/small/Desktop/Images for CNN/test/'
    new_src = '/mnt/c/Users/small/Desktop/Images for CNN/inverted/'
    temp = '/mnt/c/Users/small/Desktop/Images\ for\ CNN/inverted/'
    for filename in os.listdir(main_src):
