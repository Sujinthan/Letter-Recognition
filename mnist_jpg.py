...
def read(dataset):
    if dataset is "training":
        ...
        fname_img = "merge/emnist-bymerge-train-images-idx3-ubyte"
        fname_lbl = "merge/emnist-bymerge-train-labels-idx1-ubyte"

    elif dataset is "testing":

        fname_img = "merge/emnist-bymerge-test-images-idx3-ubyte"
        fname_lbl = "merge/emnist-bymerge-test-labels-idx1-ubyte"
